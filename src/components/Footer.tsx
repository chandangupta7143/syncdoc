const footerLinks = {
  ...
  Resources: ['Help Center', 'Community', 'Templates', 'Webinars', 'API Reference'],
      ...
      <div className="mx-auto max-w-7xl px-6 py-16">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-10">
          ...
          <div className="col-span-2 md:col-span-4 lg:col-span-1 mb-4 lg:mb-0">
            <a href="/" className="flex items-center gap-2">
              ...
              <span className="text-lg font-bold text-white">SyncDoc</span>
            </a>
            <p className="mt-4 text-sm text-surface-200 leading-relaxed max-w-xs">
              AI-powered collaborative workspace for modern teams who want to write, edit, and ship faster.
            </p>
        ...
        <div className="mt-16 pt-8 border-t border-surface-800 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-sm text-surface-200">
            &copy; {new Date().getFullYear()} SyncDoc. All rights reserved.
          </p>
          <p className="text-sm text-surface-200">
